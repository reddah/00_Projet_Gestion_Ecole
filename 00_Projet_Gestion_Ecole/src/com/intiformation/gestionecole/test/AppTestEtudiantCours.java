...
public class AppTestEtudiantCours {
	...
	public static void main(String[] args) {
		...
		CoursDaoImpl coursDaoImpl = new CoursDaoImpl();
		Cours cours = coursDaoImpl.getById(1);

		EtudiantDaoImpl etudiantDaoImpl = new EtudiantDaoImpl();
		Etudiant etudiant = etudiantDaoImpl.getById(3);

		EtudiantCours etudiantCours = new EtudiantCours(false, "Motif1", cours, etudiant);
